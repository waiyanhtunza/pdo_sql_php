<?php require "./partials/head.php" ?>
    <div class="w-1/3 mx-auto my-24 h-auto bg-white rounded-2xl  p-4 drop-shadow-2xl">
        ...
        <form action="register.php" method="post" class="flex flex-col items-center justify-around" >
            ...
            <input type="number" name="phone" id="" class="border-2 w-8/12  m-4 h-10 rounded-2xl text-center text-gray-600 text-sm drop-shadow-md" placeholder="Phone Number">
            <input type="password" name="fpassword" id="" class="border-2 w-8/12  m-4 h-10 rounded-2xl text-center text-gray-600 text-sm drop-shadow-md" placeholder="New Password">
